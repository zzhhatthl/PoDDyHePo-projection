 ...
 * Arguments NsVar, df, knots, b.knots are for customizing ns function in the model. 
    + NsVar specifies variables with natural spline (two or more variables supported), if it is NULL, 
 ...
 * Second argument, `m`, is the number of multiple imputations, by default this is 5, but much greater value is usually needed in practice. 
