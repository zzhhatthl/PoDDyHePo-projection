 ...
 * `grpVar` is the grouping variable. By default, it is `sex.` The grouping variable should not have any missing value, like `year`, `sex` and `age`. In order to use `age` as grouping variable, you much change numeric age into predefined age group.
