...
In the function PoDDyHePoModelSelection(imp, DV, NsVar = NULL, df = NULL, knots = NULL, b.knots = NULL, f.var = NULL), the first argument imp is an object of class from in mice package (see Step 1). 
 ...
 * Arguments NsVar, df, knots, b.knots are for customizing ns function in the model. 
    ...
    + breakpoints that define the spline (knots) and boundary points (b.knots) are ignored; if it is not NULL, we can set df or knots and b.knots. Examples are given as follows based on testdata. 
